	...
	$.fn.contadorHeader = function(parametros){
		...
		creacontenido: function(type,data){
			...
			.done(function(banderas) {
				...
				break;
				case "proximo": 
					var mesNum = parseInt(data.MatchDate.substring(3,5)), nameMes="";
					switch(mesNum){
						case 1: nameMes="Ene."; break;
						case 2: nameMes="Feb."; break;
						case 3: nameMes="Mar."; break;
						case 4: nameMes="Abr."; break;
						case 5: nameMes="May."; break;
						case 6: nameMes="Jun."; break;
						case 7: nameMes="Jul."; break;
						case 8: nameMes="Ago."; break;
						case 9: nameMes="Sep."; break;
						case 10: nameMes="Oct."; break;
						case 11: nameMes="Nov."; break;
